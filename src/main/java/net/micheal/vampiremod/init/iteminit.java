...
public class iteminit {
   ...
   public static final RegistryObject<Item> vampire_gem = Item.register("vampire_gem", () -> new Item(new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
    ...
    public static final RegistryObject<ArmorItem> gold_chain = Item.register("gold_chain", () -> new ArmorItem(ArmorMaterials.GOLD, EquipmentSlot.CHEST, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
